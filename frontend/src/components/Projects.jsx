...
const ProjectCard = ({ project, darkMode, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Action Buttons */}
      <div className="flex items-center gap-3 pt-4 border-t ${darkMode ? 'border-gray-700' : 'border-gray-200'}">
        {hasDetails && (
          <button
        ...
        {project.githubLink && (
          <a
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium border-2 transition-all duration-300 ${
              darkMode
