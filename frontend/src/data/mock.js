...
export const projects = [
  {
    ...
    description: "Built an enterprise customer support agent integrating GPT-4o with FAISS vector database and OpenAI embeddings for semantic ticket retrieval and automated response generation using RAG architecture.",
    image: null,
    link: null,
    githubLink: null,
    type: "Project",
    tags: ["GPT-4o", "FAISS", "LangChain", "RAG", "AzureML", "Streamlit"],
    details: {
      heroDescription: "An enterprise-grade customer support agent that combines GPT-4o with FAISS vector database for intelligent ticket retrieval and automated response generation. The system uses RAG architecture to provide accurate, context-aware support responses.",
      duration: null,
      role: null,
      projectType: null,
      overview: "This project delivers an AI-powered customer support solution that automates ticket categorization, sentiment analysis, and response generation. By integrating GPT-4o with FAISS vector database and implementing a RAG architecture, the system provides accurate and contextual responses while maintaining enterprise-grade security and governance.",
      industryChallenge: "Enterprise customer support teams face challenges with high ticket volumes, inconsistent response quality, and long resolution times. Manual ticket categorization and response drafting is time-consuming and prone to errors, leading to poor customer satisfaction and increased operational costs.",
      architectureDescription: "The solution combines retrieval-based and generation-based approaches using RAG architecture. Customer tickets are embedded using OpenAI embeddings and stored in FAISS for semantic retrieval. GPT-4o generates contextual responses based on retrieved similar tickets and knowledge base articles.",
      architectureFlow: [
        "Ticket Input",
        "OpenAI Embeddings",
        "FAISS Vector Search",
      ...
      techStack: [
        ...
        { name: "AzureML", category: "Deployment", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/azure/azure-original.svg" },
      ...
      keyFeatures: [
        "Semantic ticket retrieval using FAISS vector database and OpenAI embeddings",
        "Automated response generation with GPT-4o using RAG architecture",
        "Ticket categorization and sentiment analysis workflows",
        "Priority assignment based on ticket content and customer history",
        "Modular APIs and prompt engineering frameworks for consistent LLM behavior",
        "Feedback loop for continuous prompt improvement and response quality monitoring",
        "Data governance protocols for customer support ticket data in Azure Blob Storage",
        "Deployed on AzureML with Azure App Service for scalability"
      ],
      metrics: [
        { value: "RAG", label: "Architecture" },
        { value: "GPT-4o", label: "LLM Model" },
  ...
  {
    id: 2,
    title: "AI Personal Assistant with AutoGen & FastAPI",
    description: "Architected a multi-agent AI system using AutoGen AgentChat with specialized agents for email management, calendar scheduling, weather forecasting, and web search with Slack integration.",
    image: null,
    link: null,
    githubLink: null,
    type: "Project",
    ...
    details: {
      heroDescription: "A production-grade multi-agent AI system built with AutoGen AgentChat, featuring specialized agents for email, calendar, weather, and web search. Integrated with Slack for enterprise deployment and real-time task execution.",
      duration: null,
      role: null,
      projectType: null,
      overview: "This project showcases a sophisticated multi-agent AI architecture where specialized agents collaborate to handle diverse tasks. Built using AutoGen AgentChat with FastAPI backend, the system demonstrates enterprise-ready agentic AI patterns with real-time monitoring and observability.",
      industryChallenge: "Modern professionals struggle with task overload across multiple applications - email, calendar, research, and communication tools. Context switching reduces productivity, and manual coordination of these tasks is inefficient. There's a need for intelligent automation that can handle multiple domains seamlessly.",
      architectureDescription: "The system uses AutoGen AgentChat to orchestrate multiple specialized agents, each with dedicated tool classes and system prompts. A FastAPI backend coordinates agent interactions while Slack integration enables enterprise deployment. Tavily powers real-time web search for context-aware task execution.",
      architectureFlow: [
        "User Request (Slack)",
        "FastAPI Backend",
      ...
      techStack: [
        ...
        { name: "Slack", category: "Integration", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/slack/slack-original.svg" },
        { name: "Python", category: "Language", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" }
      ],
      keyFeatures: [
        "Multi-agent architecture with specialized agents for email, calendar, weather, and web search",
        "AutoGen AgentChat for agent coordination and orchestration",
        "FastAPI backend for scalable API deployment",
        "Slack integration for enterprise communication",
        "Tavily-powered search for real-time, context-aware task execution",
        "Modular agent architecture with dedicated tool classes and system prompts",
        "Production-grade observability through structured logging",
        "Real-time monitoring across all agent operations"
      ],
      metrics: [
        { value: "4+", label: "Specialized Agents" },
        { value: "AutoGen", label: "Framework" },
        { value: "Real-time", label: "Task Execution" },
